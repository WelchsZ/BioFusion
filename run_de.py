...
import os
from DE.configs import global_config, paths_config
from DE.multi_id_coach import MultiIDCoach
from DE.single_id_coach import SingleIDCoach
from DE.utils.ImagesDataset import ImagesDataset

def run_DE(run_name='', use_wandb=False, use_multi_id_training=False):
...
if __name__ == '__main__':
    run_DE(run_name='few-car-2', use_wandb=False, use_multi_id_training=False)
